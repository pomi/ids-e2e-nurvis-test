...
public enum PreferLevelType {
    ...
    /**
     * Preference level that indicates request is only for a specific
     *                         criterion.
     *                     
     * 
     */
    ...
    /**
     * Preference level that indicates request is unnacceptable for a
     *                         specific criterion.
     *                     
     * 
     */
    ...
    /**
     * Preference level that indicates request is preferred for a specific
     *                         criterion.
     *                     
     * 
     */
    ...
    /**
     * Preference level that indicates request is required for a specific
     *                         criterion.
     *                     
     * 
     */
