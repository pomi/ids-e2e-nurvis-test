...
@XmlSeeAlso({
        com.thomascook.toscaAdapter.response.ItineraryItemRequestType.RentalCar.class,
        com.thomascook.toscaAdapter.response.ItineraryItemResponseType.RentalCar.class
})
