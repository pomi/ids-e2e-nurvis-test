...
@XmlSeeAlso({
    com.thomascook.toscaAdapter.response.VehicleRentalCoreType.PickUpLocation.class,
    com.thomascook.toscaAdapter.response.VehicleRentalCoreType.ReturnLocation.class
})
