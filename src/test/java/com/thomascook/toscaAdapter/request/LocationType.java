...
@XmlSeeAlso({
        com.thomascook.toscaAdapter.request.VehicleRentalCoreType.PickUpLocation.class,
        com.thomascook.toscaAdapter.request.VehicleRentalCoreType.ReturnLocation.class
})
