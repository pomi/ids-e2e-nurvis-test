...
@XmlSeeAlso({
        com.thomascook.toscaCostAdapter.response.ItineraryItemRequestType.RentalCar.class,
        com.thomascook.toscaCostAdapter.response.ItineraryItemResponseType.RentalCar.class
})
