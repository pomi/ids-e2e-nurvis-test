...
@XmlSeeAlso({
    com.thomascook.toscaCostAdapter.request.ItineraryItemRequestType.RentalCar.class,
    com.thomascook.toscaCostAdapter.request.ItineraryItemResponseType.RentalCar.class
})
