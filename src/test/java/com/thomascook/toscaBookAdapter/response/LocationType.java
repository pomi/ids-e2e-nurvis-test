...
@XmlSeeAlso({
    com.thomascook.toscaBookAdapter.response.VehicleRentalCoreType.PickUpLocation.class,
    com.thomascook.toscaBookAdapter.response.VehicleRentalCoreType.ReturnLocation.class
})
