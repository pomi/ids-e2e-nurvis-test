...
@XmlSeeAlso({
        com.thomascook.toscaBookAdapter.response.ItineraryItemRequestType.RentalCar.class,
        com.thomascook.toscaBookAdapter.response.ItineraryItemResponseType.RentalCar.class
})
