...
@XmlSeeAlso({
        com.thomascook.toscaBookAdapter.request.ItineraryItemRequestType.RentalCar.class,
        com.thomascook.toscaBookAdapter.request.ItineraryItemResponseType.RentalCar.class
})
