...
@XmlSeeAlso({
    com.thomascook.toscaBookAdapter.request.VehicleRentalCoreType.PickUpLocation.class,
    com.thomascook.toscaBookAdapter.request.VehicleRentalCoreType.ReturnLocation.class
})
