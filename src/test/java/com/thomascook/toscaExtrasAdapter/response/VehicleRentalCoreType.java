...
@XmlSeeAlso({
        com.thomascook.toscaExtrasAdapter.response.ItineraryItemRequestType.RentalCar.class,
        com.thomascook.toscaExtrasAdapter.response.ItineraryItemResponseType.RentalCar.class
})
