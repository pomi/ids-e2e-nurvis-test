...
public class OTAPkgExtrasInfoRS {
     ...
     *              {@link ExtraGroups }
     */
    public void setExtraGroups(ExtraGroups value) {
    ...
    public static class ExtraGroups {
         ...
         * {@link ExtraGroup }
         */
        public List<ExtraGroup> getExtraGroup() {
            if (extraGroup == null) {
                extraGroup = new ArrayList<>();
            }
