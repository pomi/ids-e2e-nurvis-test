...
@XmlSeeAlso({
    com.thomascook.toscaExtrasAdapter.request.ItineraryItemRequestType.RentalCar.class,
    com.thomascook.toscaExtrasAdapter.request.ItineraryItemResponseType.RentalCar.class
})
